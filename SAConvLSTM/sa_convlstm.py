...
class SAConvLSTM(nn.Module):
    def __init__(self, input_dim, hidden_dim, d_attn, kernel_size):
        ...
        self.conv_output = nn.Conv2d(self.hidden_dim[-1], 6, kernel_size=1)

    def forward(self, input_x, device=torch.device('cuda:0'), input_frames=28, future_frames=28, output_frames=55,
